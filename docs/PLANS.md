...
| [plan_cues.md](plans/plan_cues.md) | Cue Engine Enhanced Capabilities | Next-cue-only firing with skip/anywhere modifiers (`cue:`, `cue*:`, `cue**:`), fuzzy embedding-based matching, and music-state cue triggers. Phase 1 (basic engine) implemented; Phase 2 (next-only + modifiers) implemented; Phase 3 (fuzzy/embedding) and Phase 4 (music cues) planned. | |
