...
| [plan_files3.md](plans/plan_files3.md) | S3-Compatible Caption File Storage (`lcyt-files` plugin) | Plugin design for storage-adapter–based caption file I/O: local FS adapter (default) and S3/R2/MinIO adapter behind `FILE_STORAGE=s3`; multipart upload, session handle teardown, migration path. | |
