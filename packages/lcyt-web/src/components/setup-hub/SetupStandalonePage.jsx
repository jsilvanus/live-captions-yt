 ...
 * Setup Hub card that embeds a device manager (Cameras/Mixers/Encoders/
 * Bridges) or a richer standalone editor (Viewports — DskViewportsPage has
 * text-layer/present-to-screen features the card doesn't attempt to
 * replicate). Shown with a banner linking back to the (highlighted) hub card
 * so it's clear the two are the same feature in two presentations, not a
 * separate page.
 *
