// Pure functions for Planner block serialization/deserialization.
// Kept in a plain .js file so node:test can import them without JSX handling.
...
export function deserializePlan(rawText) {
  ...
  for (let i = 0; i < rawLines.length; i++) {
    ...
    // Other metadata-only line → codes block
