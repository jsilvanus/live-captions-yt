 ...
 *
 * Duplicated from lcyt-rtmp's hls-segment-fetcher.js — plugins in this
 * codebase do not import each other's source directly (they're wired
 * together via manager-instance injection in lcyt-backend), so this plugin
 * carries its own copy to stay independently installable.
 *
 * Events:
